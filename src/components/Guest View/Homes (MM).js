...
import gramercy from "./images/gramercy-residences.jpg";
import pacific from "./images/pacific-plaza-towers.jpg";
import azure from "./images/azure-urban-resort.jpg";
import wackWack from "./images/8-wack-wack-road.jpg";
...
const MM = () => {
  ...
  const metroManila = [
    {
      ...
      desc: "Luxury suites with skyline views and premium city access.",
      price: "₱2,500.00 / night",
      rating: "4.7",
      image: gramercy,
    },
    {
      name: "Pacific Plaza Towers",
    ...
    {
      name: "Azure Urban Resort",
      desc: "Beach-style living with a man-made pool, white sand, and amenities.",
      price: "₱6,899.00 / night",
      rating: "4.6",
      image: azure,
    },
    {
      name: "8 Wack Wack Road",
      desc: "Quiet residential condo near Ortigas with spacious rooms.",
      price: "₱5,900.00 / night",
      rating: "4.5",
      image: wackWack,
    },
  ];

  // 🌆 Additional Apartments in Metro Manila
  // const metroManila2 = [
  //   {
  //     name: "One Rockwell East Tower",
  //     desc: "Sleek studio/1BR in Rockwell Center, Makati with full amenities.",
  ...
  //     desc: "Upscale condo in Century City, Makati with designer finishes.",
  ...
  //   {
  //     name: "The Beacon",
  //     desc: "High-rise in Makati with city-views, gym and pool access.",

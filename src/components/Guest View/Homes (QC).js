...
// Apartment images
import vivaldi from "./images/vivaldi-residences.jpg";
import vista from "./images/vista-309-katipunan.jpg";
import princeDavid from "./images/prince-david-condo.jpg";
import princeton from "./images/princeton-residences.jpg";
import cresmont from "./images/cresmont.png";
import high from "./images/high-park.png";
import aurora from "./images/aurora-escalades.png";
...
const QC = () => {
  ...
  // 🏙️ Apartments in Quezon City
  const quezonCity = [
    { name: "Vivaldi Residences", desc: "Modern Condo Beside Cubao MRT. Great For Travelers.", price: "₱2,300.00 / night", rating: "4.4", image: vivaldi },
    { name: "Vista 309 Katipunan", desc: "Student-Friendly Units Near Ateneo. Perfect For Students Nearby.", price: "₱3,360.00 / night", rating: "4.5", image: vista },
    { name: "Prince David Condo", desc: "Elegant High-Rise Near Katipunan Avenue.", price: "₱4,000.00 / night", rating: "4.3", image: princeDavid },
    { name: "Princeton Residences", desc: "SMDC Condo Beside Gilmore LRT. It Provides Great View Of The City.", price: "₱3,900.00 / night", rating: "4.6", image: princeton },
  ];

  // const quezonCity2 = [
  //   { name: "The Crestmont", desc: "Modern 57 sqm 2-BR unit in the heart of QC, near malls & transport hubs.", price: "₱4,600.00 / night", rating: "4.7", image: cresmont },
  //   { name: "High Park Tower 2", desc: "Studio condo on the 47th floor, fully furnished, luxury tower with amenities.", price: "₱3,500.00 / night", rating: "4.9", image: high },
  //   { name: "Aurora Escalades, Cubao", desc: "Studio unit along Aurora Blvd near Araneta City — convenient for travelers.", price: "₱2,800.00 / night", rating: "4.5", image: aurora },
  //   { name: "Eastwood Le Grand", desc: "One-bedroom condo in a high-rise by Eastwood City, leisure & urban vibes.", price: "₱5,200.00 / night", rating: "4.6", image: eastwood },
  // ];

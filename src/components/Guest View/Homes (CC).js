...
import horizons from "./images/horizons.png";
import avida from "./images/avida.png";
import mivela from "./images/mivela.png";
import rise from "./images/rise.png";
import nivel from "./images/nivel.png";
import primeworld from "./images/primeworld.png";
import lahug from "./images/lahug.png";
...
const CC = () => {
  ...
  const cebuCity = [
    {
      name: "Horizons 101 Tower 1",
      desc: "One of Cebu’s tallest towers, minutes from Ayala & IT Park with skyline views.",
    ...
    },
    {
      ...
      desc: "Stylish condo in IT Park, perfect for business or stay-cation.",
      price: "₱3,800.00 / night",
      rating: "4.6",
      image: avida,
    },
    {
      name: "Mivela Garden Residences",
      desc: "Garden-themed towers in Banilad near malls – calm retreat in the city.",
      price: "₱2,900.00 / night",
      rating: "4.4",
      image: mivela,
    },
    {
      name: "The Rise at Monterrazas",
  ...
  // 🌆 Additional Apartments in Cebu City
  const cebuCity2 = [
    {
      name: "128 Nivel Hills Tower 1",
    ...
    {
      name: "Primeworld Pointe",
      desc: "La Guardia, Lahug – near IT Park, ideal for short stays and young travellers.",
      price: "₱2,600.00 / night",
      rating: "4.3",
      image: primeworld,
    },
    {
      name: "Be Residences Lahug",
      desc: "Modern condo near Cebu Business Park, perfect access to dining.",
      price: "₱3,500.00 / night",
      rating: "4.5",
      image: lahug,
    },
    {
      name: "The Median Flats",
      desc: "Loft-style units near IT Park with urban feel and amenities for work & leisure.",
      price: "₱3,100.00 / night",
      rating: "4.4",
      image: median,
    },
  ];

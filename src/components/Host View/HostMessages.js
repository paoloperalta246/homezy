...
import { Home, Clipboard, User, Gift, MessageSquare, Calendar, Send, Search, Ticket } from "lucide-react";
...
const HostMessage = () => {
  ...
  <aside className="w-full md:w-[340px] bg-white/70 backdrop-blur-md border border-gray-200 rounded-2xl shadow-md p-4 md:p-5 h-[60vh] md:h-[80vh] flex flex-col">
    ...
    <div className="flex items-center justify-between mb-3 md:mb-5">
      <h2 className="text-lg md:text-xl font-bold text-[#0B2545] flex items-center gap-2">
        💬 Messages
      </h2>
